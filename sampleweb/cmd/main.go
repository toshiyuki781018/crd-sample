...
import (
	...
	"example.com/sampleweb/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5bf3e0e5.example.com",
	...
	if err = (&controller.FirstCrdReconciler{
		Client:   mgr.GetClient(),
		Log:      ctrl.Log.WithName("controller").WithName("FirstCrd"),
